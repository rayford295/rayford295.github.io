...
<head>
  ...
  <style>
    ...
    #presentation .conference-footprint {
      margin-top: 1.75rem;
      padding-top: 1rem;
      border-top: 1px solid #e3e8ef;
    }

    #presentation .conference-footprint h3 {
      margin: 0 0 0.8rem;
      font-size: 0.98em;
      font-weight: 750;
      line-height: 1.3;
...
<section id="publications">
  ...
  <div class="paper-box" data-publication-year="2026">
    ...
    <div class="paper-box-text">
      ...
      <em>Proceedings of the 34th ACM SIGSPATIAL International Conference on Advances in Geographic Information Systems (SIGSPATIAL '26)</em>, November 3–6, 2026, Riverside, CA, USA. ACM, New York, NY, USA, 12 pages.
...
<section id="professional-activities-and-service">
  <h2>👔 Professional Activities and Service</h2>
    <ul>
    <li>
      <em>Student Director, <a href="https://www.aag.org/groups/geographic-information-science-and-systems/" target="_blank" rel="noopener">Geographic Information Science and Systems (GISS) Specialty Group</a></em>,
      <a href="https://www.aag.org/" target="_blank" rel="noopener">American Association of Geographers</a>, 2026 – 2027
    </li>
    <li>
...
<section id="personal-gallery" class="personal-gallery">
  ...
  <div class="personal-gallery-grid">
    ...
    <figure>
      <img src="/images/goro-first-class.png" alt="Portrait with a white giant tower and the quote A first-rate person does everything first-rate" loading="lazy" decoding="async">
...
<section id="miscellaneous" class="misc-section">
  ...
  <div class="hobby-gallery">
    ...
    <figure class="hobby-card">
      <img src="/hobby/cristiano-ronaldo-final-dance.png" alt="Cristiano Ronaldo's final-dance eFootball card reveal in the Portugal kit" loading="lazy" decoding="async">
      <figcaption>
        <strong>Cristiano Ronaldo: Final Dance</strong>
        <span>Cristiano Ronaldo's final-dance card reveal in the Portugal kit.</span>
      </figcaption>
    </figure>
    <figure class="hobby-card">
